...
The :ref:`timingobject` is the foundation for a **new timing model**, enabling synchronization and consistency across multiple media sources, media types, media components or media frameworks. Also, crucially, this timing model expands the scope of synchronization and consistency from local media experiences (i.e. within a Web page) to globally distributed media experiences.
